...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			{
				if(confirm("删除一级目录将删除该目录下的二级分类目录，且该分类下的商品变成无分类状态，确定删除？"))
				{
					return true;
				}
				else {
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="c" value="cList" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminCategory_delete.action?cid=<s:property value="#c.cid"/>" onClick="return  delete_confirm()">
