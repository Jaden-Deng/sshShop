							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="product" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<img alt="商品图" width="40" height="45" src="${pageContext.request.contextPath}/<s:property value="#product.image"/>">
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<s:if test="#product.is_hot==1">是</s:if><s:else>否</s:else>
											</td>
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminProduct_delete.action?pid=<s:property value="#product.pid"/>" onClick="return  delete_confirm()">
					...
					<tr align="center">
						<td class="ta_01" align="center" bgColor="#afd1f3">
							...
							<s:if test="pageBean.page!=1">
								...
								<a href="${pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.page-1"/>" >上页</a>
							</s:if>
							<s:if test="pageBean.page!=pageBean.totalPage">
								<a href="${pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.page+1"/>" >下页</a>
