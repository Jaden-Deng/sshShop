		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					二级分类名称：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text" name="csname" value="<s:property value="model.csname"/>"
				...
				<select name="category.cid">
						<s:iterator var="c" value="clist">
							<option value="<s:property value="#c.cid"/>" <s:if test="model.category.cid==#c.cid">selected="selected"</s:if> >
