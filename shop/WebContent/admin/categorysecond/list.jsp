...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			{
				if(confirm("删除二级目录后该目录下的商品将变成无分类状态，确定删除？"))
				{
					return true;
				}
				else {
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="cs" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminCategorySecond_delete.action?csid=<s:property value="#cs.csid"/>" onClick="return  delete_confirm()">
					...
					<tr align="center">
						<td class="ta_01" align="center" bgColor="#afd1f3">
							...
							<s:if test="pageBean.page!=1">
								...
								<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll.action?page=<s:property value="pageBean.page-1"/>" >上页</a>
							</s:if>
							<s:if test="pageBean.page!=pageBean.totalPage">
								<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll.action?page=<s:property value="pageBean.page+1"/>" >下页</a>
